...
import ar.edu.ort.tp1.parcial1.clases.Animal;
import ar.edu.ort.tp1.parcial1.clases.Conejo;
import ar.edu.ort.tp1.parcial1.clases.Doctor;
import ar.edu.ort.tp1.parcial1.clases.Estado;
import ar.edu.ort.tp1.parcial1.clases.Gato;
import ar.edu.ort.tp1.parcial1.clases.Perro;
import ar.edu.ort.tp1.parcial1.clases.Veterinaria;
...
public class Parcial1 {
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * mascota.comer(10); mascota.defecar();
		 * 
		 * mascota = clinicaVeterinaria.buscarMascota("Guardian"); mascota.comer(5);
		 * mascota.defecar();
		 * 
		 * mascota = clinicaVeterinaria.buscarMascota("Eric"); mascota.comer(55);
		 * mascota.defecar();
		 */
