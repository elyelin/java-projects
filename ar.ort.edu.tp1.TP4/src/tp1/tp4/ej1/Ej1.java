...
public class Ej1 {
	 ...
	 * 
	 * @param input el scanner a usar para la carga del nro.
...
/*
 * 
 * ¿Qué sucede cuando se carga un valor no numérico? - Se dispara la
 * excepcion que maneja el el pedirNumeroEntero
 * 
 * Si comentamos todos los try catch, se la aplicacion rome y muestra el tipo de
 * excepcion por la que rompio. Si comentamos solo los try cartch
 * pediNumeroEntero la apliacion mostrara el error de la excepcion
 * 
 */