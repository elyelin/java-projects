...
public class TestEjercicio05 {
	...
	public static void main(String[] args) {
		...
		fecha1.agregarPartido(sanLorenzovsracing);
		fecha1.agregarPartido(rivervsvelez);
		fecha1.agregarPartido(bocavsindependiente);
		fecha1.agregarPartido(sanLorenzovsvelez);
		fecha1.agregarPartido(bocavsRacing);
		fecha2.agregarPartido(bocavssanLorenzo);
		fecha2.agregarPartido(rivervsracing);
		fecha2.agregarPartido(velezvsindependiente);
		fecha3.agregarPartido(bocavsriver);
		fecha3.agregarPartido(sanLorenzovsindependiente);
		fecha3.agregarPartido(racingvsvelez);
		fecha4.agregarPartido(racingvsvelez);
		fecha4.agregarPartido(bocavsvelez);
		fecha4.agregarPartido(sanLorenzovsriver);
		fecha5.agregarPartido(racingvsindependiente);
		fecha5.agregarPartido(bocavsRacing);
		fecha5.agregarPartido(rivervsindependiente);
